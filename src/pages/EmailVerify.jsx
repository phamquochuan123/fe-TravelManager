...
const EmailVerify = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-600 via-blue-700 to-cyan-600 font-['Outfit'] relative overflow-hidden">
            {/* Decorative orbs */}
