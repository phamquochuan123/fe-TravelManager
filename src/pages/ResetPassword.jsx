...
const ResetpassWord = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden font-['Outfit'] bg-gradient-to-br from-sky-600 via-blue-700 to-cyan-600 p-6">
