  ...
  return (
    <div className="p-6 space-y-5" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#1a5276' }}>Quản lý thanh toán</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Doanh thu (trang)', value: fmtVND(totalRevenue), color: '#1a5276', bg: '#eaf4fb' },
        ].map(k => (
              ...
              {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                ...
                return (
                  <button
                    ...
                    style={pg === page ? { backgroundColor: '#1a5276' } : undefined}
                  >
                    {pg + 1}
                  </button>
                )
